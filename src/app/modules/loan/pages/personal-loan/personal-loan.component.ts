...
export class PersonalLoanComponent implements OnInit {
  ...
  public countryList: Array<any> = [
    ...
    { name: "Dadra and Nagar Haveli (DN)", cities: ["Dadra and Nagar Haveli"] },
    { name: "Daman and Diu (DD)", cities: ["Daman", "Diu"] },
    {
      name: "Delhi (DL)",
      cities: [
        "Central Delhi",
    ...
    { name: "Goa (GA)", cities: ["North Goa", "South Goa"] },
    {
      name: "Gujarat (GJ)",
      cities: [
        "Ahmedabad",
    ...
    {
      name: "Pondicherry (Puducherry) (PY)",
  ...
  public sendPersonalLoan() {
    this.submitted = true;
    if (this.enquiryForm.invalid) {
      return;
    }
    this.spinnerService.show();
    this.apiservice.post("/personal/send", this.enquiryForm.value).subscribe(
      (res) => {
        this.spinnerService.hide();
        Swal.fire(
          "Thank you, we have received your info",
          "A customer service representative will be in touch within 24 hours",
          "success"
        );
      },
      (error) => {
